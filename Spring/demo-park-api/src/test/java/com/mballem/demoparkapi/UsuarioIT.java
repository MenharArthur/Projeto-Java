...
public class UsuarioIT {
    ...
    @Test
    public void buscarUsuarios_ComIdExistente_RetornarUsuarioComStatus200(){
        UsuarioResponseDto responseBody = testClient
                .get()
                .uri("/api/v1/usuarios/100")
                .headers(jwtAuthentication.getHeadersAuthorization(testClient,"joey@email.com","123456"))
                .exchange()
                .expectStatus().isOk()
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getUsername()).isEqualTo("joey@email.com");
        ...
        responseBody = testClient
                .get()
                .uri("/api/v1/usuarios/101")
                .headers(jwtAuthentication.getHeadersAuthorization(testClient,"ana@email.com","123456"))
                .exchange()
                .expectStatus().isOk()
                .expectBody(UsuarioResponseDto.class)
                .returnResult().getResponseBody();
    ...
    @Test
    public void buscarListaUsuarios_RetornarUmaListaUsuarioComStatus200(){
